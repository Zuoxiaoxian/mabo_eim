...
export class MenuComponent implements OnInit {
  ...
  constructor(protected dialogRef: NbDialogRef<MenuComponent>, private userinfoservice: UserInfoService, private httpservice: HttpserviceService, private publicmethod: PublicmethodService) { }
